...
const (
	...
	SPIF_UPDATEANDSENDINI = 0x03 // not in the docs, but everyone sets it themselves
)
...
const (
	...
	SPI_SETDOUBLECLKHEIGHT          = 0x001E // not a typo
	SPI_SETDOUBLECLKWIDTH           = 0x001D // not a typo
...
// UI effects
// SPI_SETUIEFFECTS is used to enable or disable all UI effects at once
const (
...
const (
	...
	SPI_GETACTIVEWNDTRKZORDER     = 0x100C // not a typo
	SPI_GETACTIVEWNDTRKTIMEOUT    = 0x2002 // not a typo
	...
	SPI_GETSHOWIMEUI              = 0x006E // not a typo
	SPI_GETSNAPSIZING             = 0x008E
	SPI_GETWINARRANGING           = 0x0082
	SPI_SETACTIVEWINDOWTRACKING   = 0x1001
	SPI_SETACTIVEWNDTRKZORDER     = 0x100D // not a typo
	SPI_SETACTIVEWNDTRKTIMEOUT    = 0x2003 // not a typo
	...
	SPI_SETSHOWIMEUI              = 0x006F // not a typo
